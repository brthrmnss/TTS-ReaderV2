...
/*
 if we make a service that can save location and resume,
 reading books will be much easier,

 goals
 store recent list and url
 store recent positon
 resume new positoin

 tasks
 when opened store opened, remove from list and put at top
 when opened to go last stored position
 when play update play head

 add auto scroll checkbox ... when click once, unselected it, when click up,
 ... renable auto scroll -- for bookmarking ...

 support reading epub files ...
 */
