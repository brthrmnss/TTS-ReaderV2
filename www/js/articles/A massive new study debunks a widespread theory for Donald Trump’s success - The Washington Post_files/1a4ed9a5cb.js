...
plugin.component.renderers.allPostsContainer=function(element){this.parentRenderer("allPostsContainer",arguments);var thisContainer=this.component.config.get("thisContainer");return element};plugin.component.renderers.streamHeader=function(element){this.parentRenderer("streamHeader",arguments);var thisContainer=this.component.config.get("thisContainer");return element};plugin.component.renderers._tabs=function(element){this.parentRenderer("_tabs",arguments);var thisContainer=this.component.config.get("thisContainer");
if(wp_e2[thisContainer].includevoteofftopic===true){var thisMarker="flag-offtopic",actionTarget=$(element).find("ul.echo-apps-conversations-tabs");var voteSettings=wp_e2["voteSettings_"+thisMarker]||{},offtopicCookie=wp_e2._getCookie(voteSettings.cookie);if($("#"+thisContainer+" .control-"+thisMarker).length==0){if(offtopicCookie=="hiding")$("#"+thisContainer+" .echo-streamserver-controls-stream").addClass(voteSettings.markClass+"-hidden");actionTarget.append('\x3cli class\x3d"pull-right"\x3e\x3cdiv class\x3d"control-'+
...
"hiding",cookieOptions)}})}}return element};Echo.Plugin.create(plugin)})(Echo.jQuery);
                  ...
                  $(".echo-apps-conversations-postComposer").find(".echo-feature-notification").fadeOut("slow");
                    $.ajax({
                      ...
                      if (data.entries && data.entries.length > 0) {
                        ...
                        var siteHierarchy = [wp_e2.canonicalUrl, wp_e2.authors, wp_e2.siteServiceSection, wp_e2.siteServiceParentSection, "comments_sitewide"];
