...
function DictArray() {
    ...
    self.add = function addItemToDictionary(key, val) {
...
sh.runWhenFileChanged = function runWhenFileChanged() { //reloader
    ...
    //sh.x()
    //var FileWatcher = sh.require(__dirname + '/FileWatcher.js').FileWatcher;
    var FileWatcher = require('./FileWatcher.js').FileWatcher;
//sh.x()
