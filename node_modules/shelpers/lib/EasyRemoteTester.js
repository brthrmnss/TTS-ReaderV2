...
function EasyRemoteTester() {
    ...
    function defineQuickRequests() {
        ...
        self.quickRequest = function quickRequest(url, method, fx, postData, doRegPost, postJSON) {
            ...
            if (self.settings.urlTimeout) {
                reqoptions.timeout = self.settings.urlTimeout;
            }
            ...
            reqoptions.fx2 = function storeContents(body, resp, error) {
                if (self.settings.silent != true && self.settings.showStatus) {
            ...
            //console.error('ERT', 'request options', reqoptions)
            if (self.settings.debugRequestOptions)
...
*/
            ...
            function nextFunctionToAdd() {
                ...
                if (reqObj.timeout == null && self.settings.defaultTimeout) {
                    reqObj.timeout = self.settings.defaultTimeout
                }

                self.quickRequest(reqObj, type, onResult, req, post2, post3)

                function onResult(body, resp, error) {
                    ...
                    if (optional == true && self.lastResponse == null) {
                        ...
                        if (self.lastResponse == null) {
                            console.error('error for' , url)//self.lastResponse
                        } else {
                    ...
                    if (innerDataForFxCall.fxOrStoreKey != null) {
                        ...
                        if (innerDataForFxCall.getProp != null) {
                            if ( val == null ) {
                                console.error('ERT', 'failed',innerDataForFxCall )
                            } else {
                    ...
                    if (innerDataForFxCall.fxEnd) {
                        var result = sh.callIfDefined(innerDataForFxCall.fxEnd, body, resp, error)
                        if (result) {
                            console.error('finishing early with', result)
                            return;
                        }
                    }
...
if (module.parent == null) {
    ...
    var quickRequest = tH.quickRequest;
